...
function PullTrain({TripType,triggerParentEffect}) {
  ...
  const handleSave = () => {
    ...
    if (filteredData.length > 0) {
      ...
      expensetransport(formDatatry, "train").then((res) => {
        if (res.responseCode === 200) {
          triggerParentEffect(formDatatry);

          message.success("Train Date Save Successfully");
        } else {
          message.error(res.responseMessage);
        }
      });
      ...
      message.error("Add full data for train to save");
    }
  };
    ...
    getExpenseTransport(requestid).then((res) => {
      if (res.responseCode === 200) {
        if (res.data.length > 0) {
          let gettrainData = res.data?.filter(
            (item) => item.transportType === "train"
          );
          if (gettrainData.length > 0) {
            if (Object.keys(gettrainData[0])?.length > 0) {
              if (gettrainData[0].trips.length > 0) {
                if (gettrainData[0]?.tripType === "multiCity") {
                  if (gettrainData[0].trips.length > 0) {
                    const initialFormDataArray = gettrainData[0].trips.map(
                      (obj) => ({
                ...
                if (gettrainData[0]?.tripType === "oneway") {
                  setDepartureDateONeWay(
                    gettrainData[0].trips[0].departureDate !== null
                      ? new Date(gettrainData[0].trips[0].departureDate)
                      : null
                  );
                  setBillDateONeWay(
                    gettrainData[0].trips[0].billDate !== null
                      ? new Date(gettrainData[0].trips[0].billDate)
                      : null
                  );
                  if (gettrainData[0].trips[0]) {
                    const initialFormDataArray = {
                      departureDateoneway:
                        gettrainData[0].trips[0].departureDate !== null
                          ...
                          : null || null,
                      estimateCostoneway:
                        gettrainData[0].trips[0].estimateCost || "",
                      fromoneway: gettrainData[0].trips[0].from || "",
                      tooneway: gettrainData[0].trips[0].to || "",
                      billDateoneway:
                      gettrainData[0].trips[0].billDate !== null
                      ? new Date(gettrainData[0].trips[0]?.billDate)
                      : null,
                      establishmentNameoneway:
                        gettrainData[0].trips[0].establishmentName || "",
                      billCurrencyoneway:
                        gettrainData[0].trips[0].billCurrency || "",
                      billAmountoneway:
                        gettrainData[0].trips[0].billAmount || "",
                      billNumberoneway:
                        gettrainData[0].trips[0].billNumber || "",
                      exchangeRateoneway:
                        gettrainData[0].trips[0].exchangeRate || "",
                      finalAmountoneway:
                        gettrainData[0].trips[0].finalAmount || "",
                      expenseTypeoneway:
                        gettrainData[0].trips[0].expenseType || "",
                      billFileOriginaloneway:
                        gettrainData[0].trips[0].billFileOriginalName || "",
                      billFileoneway: gettrainData[0].trips[0].billFile || "",
                    };
                ...
                if (gettrainData[0]?.tripType === "round") {
                  ...
                  setDepartureDateroundway1(
                    gettrainData[0]?.trips[1]?.departureDate !== null
                      ? new Date(gettrainData[0]?.trips[1]?.departureDate)
                      : null
                  );
                  setBillDateroundway(
                    gettrainData[0]?.trips[0]?.billDate !== null
                  ...
                  setBillDateroundway1(
                    gettrainData[0]?.trips[1]?.billDate !== null
                      ? new Date(gettrainData[0]?.trips[1]?.billDate)
                      : null
                  );
                  if (gettrainData[0]?.trips[0]) {
                    const initialFormDataArray = {
                      ...
                      estimateCostroundway0:
                        gettrainData[0]?.trips[0]?.estimateCost || "",
                      fromroundway0: gettrainData[0]?.trips[0]?.from || "",
                      toroundway0: gettrainData[0].trips[0].to || "",
                      establishmentNameroundway0:
                        gettrainData[0].trips[0].establishmentName || "",
                      billCurrencyroundway0:
                        gettrainData[0].trips[0].billCurrency || "",
                      ...
                      billFileOriginalroundway0:
                        gettrainData[0].trips[0].billFileOriginalName || "",
                      billFileroundway0:
                        gettrainData[0].trips[0].billFile || "",
                      departureDateroundway1:
                        gettrainData[0]?.trips[1]?.departureDate !== null
                          ? new Date(gettrainData[0]?.trips[1]?.departureDate)
                          : null || null,
                      estimateCostroundway1:
                        gettrainData[0].trips[1]?.estimateCost || "",
                      fromroundway1: gettrainData[0].trips[1]?.from || "",
                      toroundway1: gettrainData[0].trips[1]?.to || "",
                      establishmentNameroundway1:
                        gettrainData[0].trips[1]?.establishmentName || "",
                      billCurrencyroundway1:
                        gettrainData[0].trips[1]?.billCurrency || "",
                      billAmountroundway1:
                        gettrainData[0].trips[1]?.billAmount || "",
                      billNumberroundway1:
                        gettrainData[0].trips[1]?.billNumber || "",
                      exchangeRateroundway1:
                        gettrainData[0].trips[1]?.exchangeRate || "",
                      expenseTyperoundway1:
                        gettrainData[0].trips[1]?.expenseType || "",
                      billFileOriginalroundway1:
                        gettrainData[0].trips[1]?.billFileOriginalName || "",
                      billFileroundway1:
                        gettrainData[0].trips[1]?.billFile || "",
                    };
    ...
    if (requestid) {
      ...
      expenseClear(body).then((res) => {
        if (res.responseCode === 200) {
          ...
          message.success("Train Data Cleared Successfully");
        } else {
          message.error(res.responseMessage);
        }
      });
